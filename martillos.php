...
<a href="assets/generar_pdf/registros.php?martillo" target="_blank" class="button btn-detalle">imprimir detalles</A>
<div class="clearfix"></div>


 <div class="detalle">
 <img src="assets/style/img/martillo.jpg">
...
<h2>no hay registros de articulos de los Martillos</h2>
<?php else: ?>
