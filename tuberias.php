...
<a href="assets/generar_pdf/registros.php?tuberias" target="_blank" class="button btn-detalle">imprimir detalles</A>
<div class="clearfix"></div>


 <div class="detalle">
 <img src="assets/style/img/tuberia.jpg">
...
<div class="table__title">Datos de la  tabla</div>
    ...
    <?php if (empty(ConseguirArticulosTuberias($BD))): ?>
<h2>no hay registros de articulos de las Tuberias</h2>
<?php else: ?>
    <?php ($articulos = ConseguirArticulosTuberias($BD));?>
