...
<a href="assets/generar_pdf/registros.php?pintura" target="_blank" class="button btn-detalle">imprimir detalles</A>
<div class="clearfix"></div>


 <div class="detalle">
 <img src="assets/style/img/pintura.jpg">
...
<h2>no hay registros de articulos de las pinturas</h2>
<?php else: ?>
